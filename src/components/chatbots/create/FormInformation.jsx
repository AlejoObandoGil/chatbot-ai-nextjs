            ...
            <div className=" bg-gray-100 flex items-center justify-center">
                <div className="bg-white p-8 rounded shadow-md w-full max-w-5xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="description" className="block text-gray-700">Descripción breve</label>
                            <textarea
                                id="description"
                                className="mt-1 block w-full border border-gray-300 rounded-md p-2"
                                value={description}
                        ...
                        <div className="mb-4">
                            <label htmlFor="knowledgeBase" className="block text-gray-700">Base de Conocimiento (Información relevante de tu empresa o sitio web)</label>
                            <textarea
                                id="knowledgeBase"
                                className="mt-1 block w-full border border-gray-300 rounded-md p-2"
                                value={knowledgeBase}
